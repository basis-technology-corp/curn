...
rem
rem Copyright (c) 2004-2009 Brian M. Clapper. All rights reserved.
rem
...
rem       copyright (c) 2004-2009 Brian M. Clapper."
rem
...
"$JAVA_HOME\bin\java" %JAVA_VM_ARGS% -classpath "$INSTALL_PATH\lib\curnboot.jar" -ea -client org.clapper.curn.Bootstrap "$INSTALL_PATH\lib" "$INSTALL_PATH\plugins" "@user.home\curn\plugins" "@user.home\.curn\plugins" "@user.home\curn\lib" "@user.home\.curn\lib" -- org.clapper.curn.Tool %1 %2 %3 %4 %5 %6 %7 %8 %9
